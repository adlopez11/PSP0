    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("Digite el nombre del archivo con la lista de numeros "
                + "a evaluar, debe colocarse en la carpeta /src/site/resources/: ");
            ...
            System.out.println("No se encuentra el archivo especificado, se debe ubicar en la carpeta /src/site/resources/");
